...
if (isset($_POST["register"])) {
  if (!empty($_POST['name']) && !empty($_POST['lname']) && !empty($_POST['address']) && !empty($_POST['codep']) && !empty($_POST['email']) && !empty($_POST['password'])) {
    $fullname = $_POST['name'];
    $lname = $_POST['lname'];
    ...
    if ($query->rowCount() > 0) {
      ...
      $query->bindParam(":apellido", $lname);
      $query->bindParam(":direccion", $address);
      $query->bindParam(":codigopostal", $codep);
      $query->bindParam(":email", $email);
          ...
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <form class="pt-3">
                ...
                <div class="form-group">
                  <input type="text" class="form-control form-control-lg" id="exampleInputEmail1" placeholder="Direccion">
                </div>
                <div class="form-group">
                  <input type="text" class="form-control form-control-lg" id="exampleInputEmail1" placeholder="Codigo Postal">
                </div>
                <div class="form-group">
                ...
                <div class="text-center mt-4 font-weight-light">
                  Ya tienes una cuenta? <a href="login.php" class="text-primary">Ingresa</a>
                </div>
              </form>
            </div>
          </div>
