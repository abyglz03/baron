...
<body>
    ...
    <section class="home-slider owl-carousel img" style="background-image: url(dist/img/pic2.JPG); width: 1450px">
            ...
            <div class="container">
                <div class="row slider-text align-items-center" data-scrollax-parent="true">
                    <div class="col-md-6 col-sm-12 ftco-animate">
                        <p>
                            <a href="carrito.html" class="btn btn-primary p-3 px-xl-4 py-xl-3">Ordena ahora</a>
                            <a href="menu.html" class="btn btn-white btn-outline-white p-3 px-xl-4 py-xl-3">Menu</a>
                        </p>
                    </div>
                    <div class="col-md-6 ftco-animate">
                        <img src="dist/img/LOGO-BARON-EFECTO.png" class="img-fluid" alt="" />
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="ftco-about d-md-flex">
        ...
        <div class="one-half ftco-animate">
            <div class="heading-section ftco-animate">
                <h2 class="mb-4">
                    Bienvendido <span class="">Barón Rosso</span> restaurant
                </h2>
            </div>
            <div>
                <p>
    ...
    <section class="ftco-menu">
        <div class="container-fluid">
            <div class="row d-md-flex">
                <div class="col-lg-4 ftco-animate img f-menu-img mb-5 mb-md-0" style="background-image: url(images/about.jpg)"></div>
